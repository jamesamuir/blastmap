...
/**
 * Search location directive
 */
var googleMapsModule = angular.module("google-maps", []);
googleMapsModule.directive("googleMap", ["$log", "$timeout", "$filter", "mapToolService", "mapSearchService", "nukeService", "socket",
    function ($log, $timeout, $filter, mapToolService, mapSearchService, nukeService, socket) {
        ...
        return {
            ...
            controller: function ($scope, $element) {
                ...
                $scope.$on('updateMapCenter', function(listener) {
                    ...
                    $scope.$apply( function () {
                        ...
                        $scope.map.addMarker(mapSearchService.getSearchLat(), mapSearchService.getSearchLng(), mapSearchService.getFormattedAddress());
            ...
            link: function (scope, element, attrs, ctrl) {
                ...
                // -----------------
                // Create our model and set to the page
                // ----------------
                ...
                (function () {
                    ...
                    _m.on("click", function (e) {
                        ...
                        if (mapToolService.getMapTool() == "mapTool.ADDMARKER") {
                            ...
                            var overlayCoords = [ ];
                            var blastPaths = GetBlastPaths(nukeService.data.selectedNuke, cm.latitude, cm.longitude);


                            socket.emit('addblast', blastPaths);
